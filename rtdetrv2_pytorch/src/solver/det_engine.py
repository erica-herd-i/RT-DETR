...
def evaluate(model: torch.nn.Module, criterion: torch.nn.Module, postprocessor, data_loader, coco_evaluator: CocoEvaluator, device):
    ...
    # # Assume you have your COCO ground truth object
    # coco = COCO("/media/herd-i/Local Disk/herdi/object_detection/dataset/cow/annotations/instances_val.json")
    ...
    for samples, targets in metric_logger.log_every(data_loader, 10, header):
        ...
        final_results = coco_evaluator.prepare_for_coco_detection(res)
    ...
    # coco_dt = coco.loadRes(batch_results)  # New detection results for this batch
    ...
    return stats, coco_evaluator, batch_results
